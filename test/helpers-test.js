...
describe("Helpers", function () {
  ...
  describe("splitRef", function () {
    ...
    it("splits multiple digit and letter values", function () {
      var t = new XlsxTemplate();
      expect(t.splitRef("AB12")).toEqual({
        table: null,
        col: "AB",
        colAbsolute: false,
        row: 12,
    ...
    it("splits absolute references", function () {
      ...
      expect(t.splitRef("AB$12")).toEqual({
        table: null,
        col: "AB",
        colAbsolute: false,
        row: 12,
    ...
    it("splits references with tables", function () {
      var t = new XlsxTemplate();
      expect(t.splitRef("Table one!AB12")).toEqual({
        table: "Table one",
        col: "AB",
        colAbsolute: false,
        row: 12,
      ...
      expect(t.splitRef("Table one!AB$12")).toEqual({
        table: "Table one",
        col: "AB",
        colAbsolute: false,
        row: 12,
  ...
  describe("joinRef", function () {
    ...
    it("joins multiple digit and letter values and absolute references", function () {
      var t = new XlsxTemplate();
      expect(
        t.joinRef({ col: "AB", colAbsolute: true, row: 12, rowAbsolute: false })
      ).toEqual("$AB12");
      expect(
        t.joinRef({ col: "AB", colAbsolute: true, row: 12, rowAbsolute: true })
      ).toEqual("$AB$12");
      expect(
        t.joinRef({
          col: "AB",
  ...
  describe("substituteScalar", function () {
    it("can substitute simple string values", function () {
      ...
      expect(
        t.substituteScalar(col, string, placeholder, substitution)
      ).toEqual("bar");
