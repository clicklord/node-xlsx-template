...
describe("CRUD operations", function () {
  describe("XlsxTemplate", function () {
    ...
    it("can substitute values and generate a file", function (done) {
      fs.readFile(
        ...
        function (err, data) {
          ...
          expect(sheet1.find("./sheetData/row/c[@r='B4']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C4']/v").text).toEqual(
            "10"
          );

          // dates placeholder - added cells
          expect(sheet1.find("./sheetData/row/c[@r='D6']/v").text).toEqual(
            "41275"
          );
          expect(sheet1.find("./sheetData/row/c[@r='E6']/v").text).toEqual(
            "41276"
          );
          expect(sheet1.find("./sheetData/row/c[@r='F6']/v").text).toEqual(
            "41277"
          );

          // planData placeholder - added rows and cells
          expect(sheet1.find("./sheetData/row/c[@r='B7']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='B8']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='B9']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C7']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C8']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C9']").attrib.t).toEqual(
            "s"
          );
          expect(
            sharedStrings
    ...
    it("can substitute values with descendant properties and generate a file", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "t2.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
    ...
    it("can substitute values when single item array contains an object and generate a file", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "t3.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
    ...
    it("сan replace values when the table contains merged cells and generate a file", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "t4.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          t.substitute(1, {
            ...
            planData: [
              ...
              {
                name: "John Wick",
                role: { name: "Mid Developer" },
              },
              {
                name: "Johnny Cage",
                role: { name: "Jun Developer" },
              },
            ],
          });
          ...
          // Dimensions should be updated
          expect(sheet1.find("./dimension").attrib.ref).toEqual("B2:D9");
          ...
          // XXX: For debugging only
          fs.writeFileSync("test/output/test10.xlsx", newData, "binary");
    ...
    it("moves columns left or right when filling lists", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-cols.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          expect(sheet1.find("./sheetData/row/c[@r='B4']/v").text).toEqual(
            "101"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='D5']/v").text).toEqual(
            "102"
          );

          // C6 should not have moved, and the old B6 should be replaced
          expect(sheet1.find("./sheetData/row/c[@r='B6']/v").text).toEqual(
            "10"
          );
          expect(sheet1.find("./sheetData/row/c[@r='C6']/v").text).toEqual(
            "103"
          );
    ...
    it("moves rows down when filling tables", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-tables.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          t.substitute("Tables", {
            ...
            dates: [
              {
                name: "John",
                dates: [new Date("2013-01-01"), new Date("2013-01-02")],
              },
              {
                name: "Bob",
                dates: [
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C7']/v").text).toEqual(
            "10"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='F7']/v").text).toEqual(
            "100"
          );

          expect(sheet1.find("./sheetData/row/c[@r='G7']/v").text).toEqual(
            "102"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='F8']/v").text).toEqual(
            "110"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C9']")).not.toBeNull();
          ...
          expect(sheet1.find("./sheetData/row/c[@r='F9']/v").text).toEqual(
            "120"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='D12']/v").text).toEqual(
            "103"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C15']/v").text).toEqual(
            "41275"
          );
          expect(sheet1.find("./sheetData/row/c[@r='D15']/v").text).toEqual(
            "41276"
          );
          expect(sheet1.find("./sheetData/row/c[@r='E15']/v").text).toEqual(
            "104"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C16']/v").text).toEqual(
            "41275"
          );
          expect(sheet1.find("./sheetData/row/c[@r='D16']/v").text).toEqual(
            "41276"
          );
          expect(sheet1.find("./sheetData/row/c[@r='E16']/v").text).toEqual(
            "41277"
          );
          ...
          expect(sheet1.find("./sheetData/row/c[@r='C17']")).not.toBeNull();
    ...
    it("replaces hyperlinks in sheet", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-hyperlinks.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          var sharedStrings = etree
            ...
            rels = etree
              .parse(
                t.archive.file("xl/worksheets/_rels/sheet1.xml.rels").asText()
              )
              .getroot();
          //expect(sheet1.find("./hyperlinks/hyperlink/c[@r='C16']/v").text).toEqual("41275");
          expect(rels.find("./Relationship[@Id='rId2']").attrib.Target).toEqual(
            "http://www.google.com"
          );
          expect(rels.find("./Relationship[@Id='rId1']").attrib.Target).toEqual(
            "mailto:john@bob.com?subject=Hello%20hello"
          );
    ...
    it("moves named tables, named cells and merged cells", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-named-tables.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          var sheet1 = etree
              ...
              .getroot(),
            workbook = etree
              .parse(t.archive.file("xl/workbook.xml").asText())
              .getroot(),
            table1 = etree
              .parse(t.archive.file("xl/tables/table1.xml").asText())
              .getroot(),
            table2 = etree
              .parse(t.archive.file("xl/tables/table2.xml").asText())
              .getroot(),
            table3 = etree
              .parse(t.archive.file("xl/tables/table3.xml").asText())
              .getroot();
          ...
          expect(
            workbook.find("./definedNames/definedName[@name='BelowTable']").text
          ).toEqual("Tables!$B$18");
          expect(
            workbook.find("./definedNames/definedName[@name='Moving']").text
          ).toEqual("Tables!$G$8");
          expect(
            workbook.find("./definedNames/definedName[@name='RangeBelowTable']")
              .text
          ).toEqual("Tables!$B$19:$C$19");
          expect(
            workbook.find(
              "./definedNames/definedName[@name='RangeRightOfTable']"
            ).text
          ).toEqual("Tables!$E$14:$F$14");
          expect(
            workbook.find("./definedNames/definedName[@name='RightOfTable']")
              .text
          ).toEqual("Tables!$F$8");

          // Merged cells have moved
          expect(
            sheet1.find("./mergeCells/mergeCell[@ref='B2:C2']")
          ).not.toBeNull(); // title - unchanged

          expect(
            sheet1.find("./mergeCells/mergeCell[@ref='B10:C10']")
          ).toBeNull(); // pushed down
          expect(
            sheet1.find("./mergeCells/mergeCell[@ref='B12:C12']")
          ).not.toBeNull(); // pushed down

          expect(
            sheet1.find("./mergeCells/mergeCell[@ref='E7:F7']")
          ).toBeNull(); // pushed down and accross
          expect(
            sheet1.find("./mergeCells/mergeCell[@ref='G8:H8']")
          ).not.toBeNull(); // pushed down and accross
    ...
    it("Correctly recalculate formula", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-formula.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          expect(sheet1.find("./sheetData/row/c[@r='D2']/f").text).toEqual(
            "Table3[Qty]*Table3[UnitCost]"
          );
    ...
    it("File without dimensions works", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "gdocs.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
    ...
    it("Array indexing", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-array.xlsx"),
        function (err, data) {
          expect(err).toBeNull();

          var t = new XlsxTemplate(data);
          t.substitute(1, {
            data: ["First row", { name: "B" }],
          });
          ...
          expect(getSharedString(sharedStrings, sheet1, "A2")).toEqual(
            "First row"
          );
    ...
    it("Arrays with single element", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-nested-arrays.xlsx"),
        function (err, buffer) {
          expect(err).toBeNull();
          ...
          fs.writeFileSync(
            "test/output/test-nested-arrays.xlsx",
            newData,
            "binary"
          );
          done();
    ...
    it("will correctly fill cells on all rows where arrays are used to dynamically render multiple cells", function (done) {
      fs.readFile(
        ...
        function (err, data) {
          ...
          expect(
            sheet1.find("./sheetData/row[@r='7']")._children.length
          ).toEqual(2 + 3);
          expect(
            sheet1.find("./sheetData/row[@r='8']")._children.length
          ).toEqual(2 + 5);
          expect(
            sheet1.find("./sheetData/row[@r='9']")._children.length
          ).toEqual(2 + 7);
    ...
    it("do not move Images", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-move-images.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          var option = {
            moveImages: false,
          ...
          var newData = t.generate();
          var drawingSheet = etree
            .parse(t.archive.file("xl/drawings/drawing1.xml").asText())
            .getroot();
          ...
          fs.writeFileSync(
            "test/output/test_donotmoveImages.xlsx",
            newData,
            "binary"
          );
          done();
    ...
    it("Move Images", function (done) {
      fs.readFile(
        ...
        function (err, data) {
          ...
          fs.writeFileSync(
            "test/output/test_moveImages.xlsx",
            newData,
            "binary"
          );
          done();
    ...
    it("Move Images with sameLine option", function (done) {
      fs.readFile(
        ...
        function (err, data) {
          ...
          fs.writeFileSync(
            "test/output/test_moveImages_withSameLineOption.xlsx",
            newData,
            "binary"
          );
          done();
    ...
    it("Insert image and create rels", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "test-insert-images.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          var option = {
          ...
          expect(rels.findall("Relationship")[0].attrib.Type).toEqual(
            "http://schemas.openxmlformats.org/officeDocument/2006/relationships/drawing"
          );
          expect(rels.findall("Relationship")[0].attrib.Target).toEqual(
            "../drawings/drawing2.xml"
          );
          var drawing2 = etree
            .parse(t.archive.file("xl/drawings/drawing2.xml").asText())
            .getroot();
          expect(drawing2.findall("xdr:oneCellAnchor").length).toEqual(1);
          expect(
            drawing2
              .findall("xdr:oneCellAnchor")[0]
              .findall("xdr:from")[0]
              .findall("xdr:col")[0].text
          ).toEqual("1");
          expect(
            drawing2
              .findall("xdr:oneCellAnchor")[0]
              .findall("xdr:from")[0]
              .findall("xdr:row")[0].text
          ).toEqual("2");
          expect(
            drawing2
              .findall("xdr:oneCellAnchor")[0]
              .findall("xdr:pic")[0]
              .findall("xdr:blipFill")[0]
              .findall("a:blip")[0].attrib["r:embed"]
          ).toEqual("rId1");
          var relsdrawing2 = etree
            .parse(
              t.archive.file("xl/drawings/_rels/drawing2.xml.rels").asText()
            )
            .getroot();
          expect(relsdrawing2.findall("Relationship").length).toEqual(1);
          expect(relsdrawing2.findall("Relationship")[0].attrib.Id).toEqual(
            "rId1"
          );
          expect(relsdrawing2.findall("Relationship")[0].attrib.Target).toEqual(
            "../media/image1.jpg"
          );
          expect(relsdrawing2.findall("Relationship")[0].attrib.Type).toEqual(
    ...
    it("Insert some format of image", function (done) {
      fs.readFile(
        ...
        function (err, data) {
          ...
          //TODO : make some test
          fs.writeFileSync(
            "test/output/insert_images_format.xlsx",
            newData,
            "binary"
          );
          done();
    ...
    it("Insert 100 image", function (done) {
      fs.readFile(
        ...
        function (err, buffer) {
          ...
          var data = {
            test:
              "Bug : If remove me, there are an error on ref.match([regex])",
            imgArray: [],
          };
          var i;
          for (i = 0; i < 100; i++) {
          ...
          fs.writeFileSync(
            "test/output/insert_100_images.xlsx",
            newData,
            "binary"
          );
          done();
  ...
  describe("Multiple sheets", function () {
    it("Each sheet should take each name", function (done) {
      fs.readFile(
        path.join(__dirname, "templates", "multple-sheets-arrays.xlsx"),
        function (err, data) {
          expect(err).toBeNull();
          ...
          var sheet1 = etree
            ...
            .getroot();
          var sheet2 = etree
            .parse(t.archive.file("xl/worksheets/sheet2.xml").asText())
            .getroot();
          expect(sheet1).toBeDefined();
          expect(sheet2).toBeDefined();
          expect(getSharedString(sharedStrings, sheet1, "A1")).toEqual(
            "page: 1"
          );
          expect(getSharedString(sharedStrings, sheet2, "A1")).toEqual(
            "page: 2"
          );
          expect(getSharedString(sharedStrings, sheet1, "A2")).toEqual(
            "Page 1"
          );
          expect(getSharedString(sharedStrings, sheet2, "A2")).toEqual(
            "Page 2"
          );

          fs.writeFileSync(
            "test/output/multple-sheets-arrays.xlsx",
            newData,
            "binary"
          );
          done();
